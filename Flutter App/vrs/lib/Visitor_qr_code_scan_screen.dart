// ignore_for_file: camel_case_types, no_logic_in_create_state, non_constant_identifier_names, must_be_immutable, depend_on_referenced_packages, prefer_typing_uninitialized_variables, empty_catches, file_names
...
import 'Visitor_active_booking_screen.dart';

class Visitor_qr_code_scan_screen extends StatefulWidget {
  String user_id = "";
  String first_name_first_char = "";
  String booking_id = "";
  Visitor_qr_code_scan_screen(
      this.user_id, this.first_name_first_char, this.booking_id,
      {super.key});

  @override
  State<StatefulWidget> createState() =>
      _Visitor_qr_code_scan_screen(user_id, first_name_first_char, booking_id);
}

class _Visitor_qr_code_scan_screen extends State<Visitor_qr_code_scan_screen> {
  String user_id = "";
  ...
  _Visitor_qr_code_scan_screen(
      this.user_id, this.renter_first_name_first_char, this.booking_id);

  get_data() async {
    String ip = Current_IP().getIP();
    String URL = "http://$ip/VRS/visitor_qr_code_scan_screen_get_date.php";
      ...
      (scanData) {
        ...
        if (result == booking_information['booking_code']) {
          ...
          Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
              builder: (context) => Visitor_active_booking_screen(
