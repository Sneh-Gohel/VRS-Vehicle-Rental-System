...
import 'package:vrs/Renter_current_booking_cancelling_screen.dart';
import 'Current_IP.dart';
import 'Home_account_screen.dart';
import 'Renter_qr_code_scan_screen.dart';

class Renter_current_booking_details_screen extends StatefulWidget {
  String user_id = "";
  ...
  @override
  State<StatefulWidget> createState() => _Renter_current_booking_details_screen(
      user_id,
...
class _Renter_current_booking_details_screen
    extends State<Renter_current_booking_details_screen> {
  String user_id = "";
  ...
  _Renter_current_booking_details_screen(
    this.user_id,
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Reter_qr_code_scan_screen(
                      user_id,
                      renter_first_name_first_char,
                      booking_id,
                    ),
