...
import 'Visitor_driver_active_booking_cancelling_screen.dart';
import 'Visitor_qr_code_scan_screen.dart';

class Visitor_driver_active_booking_deatils_screen extends StatefulWidget {
  String user_id = "";
  ...
  String driver_id = "";
  String driver_image = "";
  Visitor_driver_active_booking_deatils_screen(
      this.user_id,
  ...
  State<StatefulWidget> createState() =>
      _Visitor_driver_active_booking_deatils_screen(
          user_id,
...
class _Visitor_driver_active_booking_deatils_screen
    extends State<Visitor_driver_active_booking_deatils_screen> {
  String user_id = "";
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Visitor_qr_code_scan_screen(user_id,
                        driver_first_name_first_char, driver_booking_id),
                  ),
                );
              },
