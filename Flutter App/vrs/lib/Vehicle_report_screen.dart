...
const List<String> report_reason_list = <String>[
  ...
  'Mismatch documents',
  'Wrong information of vehicle',
  'Other'
];

String reason = report_reason_list.first;

class Vehicle_report_screen extends StatefulWidget {
  String user_id = "";
  String first_name_first_char = "";
  String vehicle_id = "";
  String vehicle_image = "";
  Vehicle_report_screen(this.user_id, this.first_name_first_char,
      this.vehicle_id, this.vehicle_image,
      {super.key});

  @override
  State<StatefulWidget> createState() => _Vehicle_report_screen(
      user_id, first_name_first_char, vehicle_id, vehicle_image);
}

class _Vehicle_report_screen extends State<Vehicle_report_screen> {
  String user_id = "";
  ...
  _Vehicle_report_screen(this.user_id, this.visitor_first_name_first_char,
      this.vehicle_id, this.vehicle_image);
  ...
  submit_press() async {
    if (reason != "Select Reason For Report") {
      if (report_descrption_Controller.text != "") {
        ...
        String responce;
        String URL = "http://$ip/VRS/report_vehicle.php";
        ...
        if (responce == "true") {
          URL = "http://$ip/VRS/vehicle_report_AI.php";
          var request = await http.post(Uri.parse(URL), body: {
            "vehicle_id": vehicle_id,
          });
          responce = (jsonDecode(request.body)).toString();
