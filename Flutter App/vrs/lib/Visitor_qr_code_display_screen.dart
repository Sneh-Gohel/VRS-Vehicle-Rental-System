...
class Visitor_qr_code_display_screen extends StatefulWidget {
  String user_id = "";
  String first_name_first_char = "";
  String booking_id = "";
  Visitor_qr_code_display_screen(
      this.user_id, this.first_name_first_char, this.booking_id,
      {super.key});

  @override
  State<StatefulWidget> createState() => _Visitor_qr_code_display_screen(
      user_id, first_name_first_char, booking_id);
}

class _Visitor_qr_code_display_screen
    extends State<Visitor_qr_code_display_screen> {
  String user_id = "";
  ...
  _Visitor_qr_code_display_screen(
      this.user_id, this.visitor_first_name_first_char, this.booking_id);

  get_data() async {
    String ip = Current_IP().getIP();
    String URL = "http://$ip/VRS/visitor_qr_code_display_screen_get_data.php";
