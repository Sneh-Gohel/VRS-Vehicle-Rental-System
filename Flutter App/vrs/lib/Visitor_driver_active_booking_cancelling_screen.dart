// ignore_for_file: camel_case_types, file_names, non_constant_identifier_names, no_logic_in_create_state, must_be_immutable, depend_on_referenced_packages
...
class Visitor_driver_active_booking_cancelling_screen extends StatefulWidget {
  String user_id = "";
  ...
  Visitor_driver_active_booking_cancelling_screen(
      this.user_id,
  ...
  State<StatefulWidget> createState() =>
      _Visitor_driver_active_booking_cancelling_screen(
          user_id,
...
class _Visitor_driver_active_booking_cancelling_screen
    extends State<Visitor_driver_active_booking_cancelling_screen> {
  String user_id = "";
  ...
  click_submit() async {
    ...
    if (reject_information_reason_for_reject_Controller.text != "") {
      ...
      String URL = "http://$ip/VRS/visitor_driver_cancle_screen.php";
      String responce;
      var request = await http.post(Uri.parse(URL), body: {
        "user_id": user_id,
        "driver_booking_id": driver_booking_id,
        "current_date": booking_reject_information_current_date,
      });
