...
class Add_driver_details_screen extends StatefulWidget {
  String user_id = "";
  String first_name_first_char = "";
  Add_driver_details_screen(this.user_id, this.first_name_first_char,
      {super.key});

  @override
  State<StatefulWidget> createState() =>
      _Add_driver_details_screen(user_id, first_name_first_char);
}

class _Add_driver_details_screen extends State<Add_driver_details_screen> {
  String user_id = "";
  ...
  _Add_driver_details_screen(this.user_id, this.driver_first_name_first_char);
            ...
            if (skill_two_wheeler == true ||
              ...
              if (fule_type_petrol == true ||
                ...
                if (transmission_manual == true || transmission_auto == true) {
                  ...
                  String responce;
                  String URL = "http://$ip/VRS/apply_as_driver.php";
                  ...
                  if (responce == "success") {
                    ...
                    request = await http.post(Uri.parse(URL), body: {
                      ...
                      "image_identifier": '1',
                      "image":
                          base64Encode(profile_image_path!.readAsBytesSync())
                    });
                    ...
                    request = await http.post(Uri.parse(URL), body: {
                      ...
                      "image_identifier": '2',
                      "image":
                          base64Encode(licence_image_1_path!.readAsBytesSync())
                    });
                    print((jsonDecode(request.body)).toString());
                    URL = "http://$ip/VRS/apply_as_driver_add_images.php";
                    request = await http.post(Uri.parse(URL), body: {
                      ...
                      "image_identifier": '3',
                      "image":
                          base64Encode(licence_image_2_path!.readAsBytesSync())
                    });
                    print((jsonDecode(request.body)).toString());
                    setState(() {
                      full_loading_screen = false;
                        ...
                        child: is_profile_image_loading
                            ...
                            : is_has_profile_image
                                ? ClipRRect(
                                    ...
                                    child: Center(
                                      child: Image.file(profile_image_path!),
                                    ),
                                  )
                                : const Center(
